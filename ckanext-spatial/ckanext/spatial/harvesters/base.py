...
class SpatialHarvester(HarvesterBase):
    ...
    def get_package_dict(self, iso_values, harvest_object):
        ...
        extras['accession-id'] = iso_values['guid']
        extras['unique-resource-identifier'] = iso_values['unique-resource-identifier']
        extras['lineage'] = iso_values['lineage']
        extras['topic-category'] = iso_values['topic-category']
        
        for date in iso_values['dataset-reference-date']:
            if date['type'] == 'publication':
                extras['publication-date'] = date['value']
        ...
        for contact in iso_values['responsible-organisation']:
            ...
            if contact['role'] == 'originator':
                ...
                publishers.append(contact)
            elif contact['role'] == 'pointOfContact':
                point_of_contact.append(contact)
            else:
